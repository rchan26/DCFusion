...
test_preconditioned_hierarchical_SMC_Poisson_scalable <- hierarchical_fusion_SMC_BLR_scalable(N_schedule = rep(100000, 2),
                                                                                              m_schedule = rep(2, 2),
                                                                                              ...
                                                                                              diffusion_estimator = 'Poisson',
                                                                                              seed = seed)
test_preconditioned_hierarchical_SMC_Poisson_scalable$particles[[1]] <- resample_particle_y_samples(particle_set = test_preconditioned_hierarchical_SMC_Poisson_scalable$particles[[1]],
                                                                                                    multivariate = TRUE,
                                                                                                    resampling_method = 'resid',
                                                                                                    seed = seed)

# preconditioned hierarchical [Negative Binomial estimator]
test_preconditioned_hierarchical_SMC_NB_scalable <- hierarchical_fusion_SMC_BLR_scalable(N_schedule = rep(100000, 2),
                                                                                         m_schedule = rep(2, 2),
                                                                                         time_schedule = rep(0.5, 2),
                                                                                         base_samples = sub_posteriors_4,
                                                                                         L = 3,
                                                                                         ...
                                                                                         diffusion_estimator = 'NB',
                                                                                         seed = seed)
test_preconditioned_hierarchical_SMC_NB_scalable$particles[[1]] <- resample_particle_y_samples(particle_set = test_preconditioned_hierarchical_SMC_NB_scalable$particles[[1]],
                                                                                               multivariate = TRUE,
                                                                                               resampling_method = 'resid',
                                                                                               seed = seed)

compare_samples_bivariate(posteriors = list(full_posterior,
                                            test_preconditioned_hierarchical_SMC_Poisson_scalable$particles[[1]]$y_samples,
                                            test_preconditioned_hierarchical_SMC_NB_scalable$particles[[1]]$y_samples),
                          colours = c('black', 'red', 'blue'),
                          common_limit = c(-4, 4),

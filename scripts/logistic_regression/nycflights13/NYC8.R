...
rm(data_split_4, data_split_16, data_split_32, data_split_64, data_split_128, data_split_256)
rm(sub_posteriors_4, sub_posteriors_16, sub_posteriors_32, sub_posteriors_64, sub_posteriors_128)
seed <- 2016
nsamples <- 30000
C <- 8
dim <- 21

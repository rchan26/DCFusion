...
rm(data_split_8, data_split_16, data_split_32, data_split_64, data_split_128, data_split_256)
rm(sub_posteriors_8, sub_posteriors_16, sub_posteriors_32, sub_posteriors_64, sub_posteriors_128)
seed <- 2016
nsamples <- 30000
C <- 4
dim <- 21
...
data_split_4 <- split_data(nyc_flights$data, y_col_index = 1, X_col_index = 2:dim, C = C, as_dataframe = F)

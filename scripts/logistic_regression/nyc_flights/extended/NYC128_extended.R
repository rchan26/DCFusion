...
NB_hc_128_T1 <- bal_binary_fusion_SMC_BLR(N_schedule = rep(nsamples, 7),
                                         m_schedule = rep(2, 7),
...
NB_hc_128_T1$particles <- resample_particle_y_samples(particle_set = NB_hc_128_T1$particles[[1]],
                                                     multivariate = TRUE,
                                                     resampling_method = 'resid',
                                                     seed = seed)
NB_hc_128_T1$proposed_samples <- NB_hc_128_T1$proposed_samples[[1]]
print(integrated_abs_distance(full_posterior, NB_hc_128_T1$particles$y_samples))

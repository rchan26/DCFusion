...
data_split_4 <- split_data(smart_grid$data, y_col_index = 14, X_col_index = 1:13, C = C, as_dataframe = F)
sub_posteriors_4 <- hmc_base_sampler_BLR_2(nsamples = nsamples_MCF,

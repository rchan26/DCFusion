...
Poisson_VBF_4 <- parallel_generalised_BF_SMC_BLR(particles_to_fuse = particles_to_fuse,
                                                 N = nsamples,
                                                 m = 4,
                                                 time_mesh = time_mesh,
                                                 dim = 5,
...
NB_VBF_4 <- parallel_generalised_BF_SMC_BLR(particles_to_fuse = particles_to_fuse,
                                            N = nsamples,
                                            m = 4,
                                            time_mesh = time_mesh,
                                            dim = 5,

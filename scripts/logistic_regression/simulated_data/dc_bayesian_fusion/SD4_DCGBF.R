...
#                            seed = seed),
GBF_4 <- list('adaptive' = bal_binary_GBF_BLR(N_schedule = nsamples,
                                              m_schedule = 4,
                                              time_mesh = NULL,
                                              base_samples = sub_posteriors_4,
                                              L = 2,
...
# 'reg' = bal_binary_GBF_BLR(N_schedule = rep(nsamples, 2),
#                            m_schedule = rep(2, 2),
#                            time_mesh = NULL,
#                            base_samples = sub_posteriors_4,
#                            L = 3,
...
#                            diffusion_estimator = diffusion_estimator,
#                            seed = seed),
balanced_C4 <- list('adaptive' = bal_binary_GBF_BLR(N_schedule = rep(nsamples, 2),
                                                    m_schedule = rep(2, 2),
                                                    time_mesh = NULL,
                                                    base_samples = sub_posteriors_4,
                                                    L = 3,

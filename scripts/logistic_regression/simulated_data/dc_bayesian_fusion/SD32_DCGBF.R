...
#                            seed = seed),
GBF_32 <- list('adaptive' = bal_binary_GBF_BLR(N_schedule = nsamples,
                                               m_schedule = 32,
                                               time_mesh = NULL,
                                               base_samples = sub_posteriors_32,
                                               L = 2,
...
# 'reg' = bal_binary_GBF_BLR(N_schedule = rep(nsamples, 5),
#                            m_schedule = rep(2, 5),
#                            time_mesh = NULL,
#                            base_samples = sub_posteriors_32,
#                            L = 6,
...
#                            diffusion_estimator = diffusion_estimator,
#                            seed = seed),
balanced_C32 <- list('adaptive' = bal_binary_GBF_BLR(N_schedule = rep(nsamples, 5),
                                                     m_schedule = rep(2, 5),
                                                     time_mesh = NULL,
                                                     base_samples = sub_posteriors_32,
                                                     L = 6,

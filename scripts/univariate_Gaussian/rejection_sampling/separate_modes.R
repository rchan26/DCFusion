...
for (i in 1:length(different_modes)) {
  ...
  fusion_samples_precondition[[i]] <- parallel_fusion_uniGaussian(N = 10000,
                                                                  m = 2,
                                                                  time = 1,
...
plot(x = different_modes, y = sapply(1:length(different_modes), function(i) fusion_samples_precondition[[i]]$time), 
     ylim = c(0, 2000), ylab = 'Running time in seconds', xlab = expression(paste('Value of ', mu)),
     col = 'black', lwd = 2, xaxt = "n")
lines(x = different_modes, y = sapply(1:length(different_modes), function(i) fusion_samples_precondition[[i]]$time),
      col = 'black', lwd = 2)
...
plot(x = different_modes, y = sapply(1:length(different_modes), function(i) fusion_samples_precondition[[i]]$rho), ylim = c(0, 1),
     ylab = expression(paste('Acceptance Rate for ', rho)), xlab = expression(paste('Value of ', mu)), 
     col = 'black', lwd = 2, xaxt = "n")
lines(x = different_modes, y = sapply(1:length(different_modes), function(i) fusion_samples_precondition[[i]]$rho),
      col = 'black', lwd = 2)
axis(1, at=0:8, labels=0:8)
axis(1, at=c(0:7)+0.5, labels=rep("", 8), lwd.ticks = 0.5)
...
plot(x = different_modes, y = sapply(1:length(different_modes), function(i) fusion_samples_precondition[[i]]$Q), ylim = c(0, 1),
     ylab = expression(paste('Acceptance Rate for ', hat(Q))), xlab = expression(paste('Value of ', mu)), 
     col = 'black', lwd = 2, xaxt = "n")
lines(x = different_modes, y = sapply(1:length(different_modes), function(i) fusion_samples_precondition[[i]]$Q),
      col = 'black', lwd = 2)
axis(1, at=0:8, labels=0:8)
axis(1, at=c(0:7)+0.5, labels=rep("", 8), lwd.ticks = 0.5)
...
plot(x = different_modes, y = sapply(1:length(different_modes), function(i) fusion_samples_precondition[[i]]$rhoQ), ylim = c(0, 1),
     ylab = 'Overall Acceptance Rate', xlab = expression(paste('Value of ', mu)), 
     col = 'black', lwd = 2, xaxt = "n")
lines(x = different_modes, y = sapply(1:length(different_modes), function(i) fusion_samples_precondition[[i]]$rhoQ), 
      col = 'black', lwd = 2)
axis(1, at=0:8, labels=0:8)
axis(1, at=c(0:7)+0.5, labels=rep("", 8), lwd.ticks = 0.5)
...
plot(x = different_modes, y = log(sapply(1:length(different_modes), function(i) fusion_samples_precondition[[i]]$rhoQ)),
     ylab = 'log(Overall Acceptance Rate)', xlab = expression(paste('Value of ', mu)), 
     col = 'black', lwd = 2, xaxt = "n")
lines(x = different_modes, y = log(sapply(1:length(different_modes), function(i) fusion_samples_precondition[[i]]$rhoQ)),
      col = 'black', lwd = 2)
axis(1, at=0:8, labels=0:8)
axis(1, at=c(0:7)+0.5, labels=rep("", 8), lwd.ticks = 0.5)

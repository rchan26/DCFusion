...
Poisson_hc_16 <- bal_binary_fusion_SMC_BNBR(N_schedule = rep(nsamples_MCF, 4),
                                            m_schedule = rep(2, 4),
...
NB_hc_16 <- bal_binary_fusion_SMC_BNBR(N_schedule = rep(nsamples_MCF, 4),
                                       m_schedule = rep(2, 4),
                                       time_schedule = rep(time_choice, 4),
                                       base_samples = sub_posteriors_16,
                                       L = 5,
...
##### all at once #####
GBF_16 <- list('reg' = bal_binary_GBF_BNBR(N_schedule = nsamples_GBF,
                                           m_schedule = 16,
                                           time_mesh = NULL,
                                           base_samples = sub_posteriors_16,
                                           L = 2,
                                           ...
                                           seed = seed))
GBF_16$adaptive <-  bal_binary_GBF_BNBR(N_schedule = nsamples_GBF,
                                        m_schedule = 16,
                                        time_mesh = NULL,
                                        base_samples = sub_posteriors_16,
                                        L = 2,

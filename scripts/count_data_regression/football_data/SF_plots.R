...
plot(x = log(c(4, 16, 32, 64), 2), y = balanced$adaptive,
     ylim = c(0, 0.4),
     xlab = '',
     ylab = '',
...
axis(1, at=log(c(4, 16, 32, 64), 2), labels = log(c(4, 16, 32, 64), 2), font = 2, cex = 1.5)
axis(2, at=seq(0, 1, 0.1), labels=c("0.0", seq(0.1, 0.9, 0.1), "1.0"), font = 2, cex = 1.5)
axis(2, at=seq(0, 1, 0.1), labels=rep("", 11), lwd.ticks = 0.5)
lines(x = log(c(4, 16, 32, 64), 2), y = balanced$reg,
      lty = 2, lwd = 3, type = 'b', pch = 2)
lines(x = log(c(4, 16, 32, 64), 2), y = consensus,
      lty = 4, lwd = 3, type = 'b', pch = 4, col = 'red')
lines(x = log(c(4, 16, 32, 64), 2), y = neiswanger,
      lty = 5, lwd = 3, type = 'b', pch = 5, col = 'red')
lines(x = log(c(4, 16, 32, 64), 2), y = weierstrass,
...
plot(x = log(c(4, 16, 32, 64), 2), y = log(balanced_time$adaptive, 2),
     ylim = c(-4, 22),
     xlab = '',
     ylab = '',
     yaxt = 'n',
...
lines(x = log(c(4, 16, 32, 64), 2), y = log(balanced_time$reg, 2),
      lty = 2, lwd = 3, type = 'b', pch = 2)
# lines(x = log(c(4, 8, 16, 32), 2), y = log(GBF_time$adaptive, 2),
#       lty = 1, lwd = 3, type = 'b', pch = 1)
lines(x = log(c(4, 16, 32, 64), 2), y = log(consensus_time, 2),
      lty = 4, lwd = 3, type = 'b', pch = 4, col = 'red')
lines(x = log(c(4, 16, 32, 64), 2), y = log(neiswanger_time, 2),
      lty = 5, lwd = 3, type = 'b', pch = 5, col = 'red')
lines(x = log(c(4, 16, 32, 64), 2), y = log(weierstrass_time, 2),
      lty = 6, lwd = 3, type = 'b', pch = 6, col = 'red')

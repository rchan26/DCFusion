...
data_split_32 <- split_data(traffic_volume$data,
                            y_col_index = 8,
                            X_col_index = 1:7,
                            C = 32,
                            as_dataframe = F)
sub_posteriors_32 <- hmc_base_sampler_BRR(nsamples = nsamples_MCF,
...
##### all at once #####
GBF_32 <- list('reg' = bal_binary_GBF_BRR(N_schedule = nsamples_GBF,
                                          m_schedule = 32,
                                          time_mesh = NULL,
                                          base_samples = sub_posteriors_32,
                                          L = 2,
...
balanced_C32 <- list('reg' = bal_binary_GBF_BRR(N_schedule = rep(nsamples_GBF, 5),
                                                m_schedule = rep(2, 5),
                                                time_mesh = NULL,
                                                base_samples = sub_posteriors_32,
                                                L = 6,
                                                ...
                                                diffusion_estimator = diffusion_estimator,
                                                seed = seed),
                     'adaptive' = bal_binary_GBF_BRR(N_schedule = rep(nsamples_GBF, 5),
                                                     m_schedule = rep(2, 5),
                                                     time_mesh = NULL,
                                                     base_samples = sub_posteriors_32,
                                                     L = 6,
